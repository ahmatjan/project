...
if("FALSE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/ros/drivers/src/car_ros_drivers/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/devel_isolated/velodyne_pointcloud)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'car-os <car-os@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/${idir}'.  Ask the maintainer 'car-os <car-os@todo.todo>' to fix it.")
    endif()
...
set(velodyne_pointcloud_EXPORTED_TARGETS "")
...
set(depends "angles;nodelet;pcl_ros;roscpp;roslib;sensor_msgs;velodyne_driver;velodyne_msgs;eigen_conversions;image_transport;cv_bridge;novatel_preprocess;time_util;math_util;msg_util")
