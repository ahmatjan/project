...
if("FALSE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/ros/nodelet_core/nodelet)
  set(nodelet_DEVEL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/devel_isolated/nodelet)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
