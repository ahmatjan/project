...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/fengkaiwen/ros/rviz)
  set(rviz_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/rviz)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'David Gossow <dgossow@gmail.com>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
