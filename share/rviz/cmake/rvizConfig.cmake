...
if("FALSE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/ros/rviz)
  set(rviz_DEVEL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/devel_isolated/rviz)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated)
...
if(NOT "include;/usr/include/eigen3;/usr/include/OGRE;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/${idir}'.  Ask the maintainer 'David Gossow <dgossow@gmail.com>, William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rviz_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz;/usr/lib/x86_64-linux-gnu/libOgreMain.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libGLU.so;/usr/lib/x86_64-linux-gnu/libGL.so;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so")
