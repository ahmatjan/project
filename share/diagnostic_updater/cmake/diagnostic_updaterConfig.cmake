...
if("FALSE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /home/fengkaiwen/ros/diagnostics/diagnostic_updater)
  set(diagnostic_updater_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/diagnostic_updater)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
