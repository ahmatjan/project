...
if("FALSE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/ros/ros_comm/rosgraph)
  set(rosgraph_DEVEL_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/devel_isolated/rosgraph)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX /home/caros/ros)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caros/ros/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
