...
if("FALSE" STREQUAL "TRUE")
  ...
  set(rosconsole_bridge_INSTALL_PREFIX /home/caros/ros)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caros/ros/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
    _list_append_unique(rosconsole_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole_bridge;/home/caros/ros/lib/libconsole_bridge.so")
