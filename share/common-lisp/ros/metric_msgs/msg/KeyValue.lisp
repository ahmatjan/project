...
(cl:defmethod cl:initialize-instance :after ((m <KeyValue>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyValue)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name metric_msgs-msg:<KeyValue> is deprecated: use metric_msgs-msg:KeyValue instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <KeyValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader metric_msgs-msg:key-val is deprecated.  Use metric_msgs-msg:key instead.")
  (key m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <KeyValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader metric_msgs-msg:value-val is deprecated.  Use metric_msgs-msg:value instead.")
  (value m))
