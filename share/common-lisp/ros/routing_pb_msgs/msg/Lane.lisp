...
(cl:defclass <Lane> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (end_s
    ...
    :initform 0.0)
   (expired_timestamp
    :reader expired_timestamp
    :initarg :expired_timestamp
    :type cl:float
    :initform 0.0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name routing_pb_msgs-msg:<Lane> is deprecated: use routing_pb_msgs-msg:Lane instead.")))
...
(cl:defmethod start_s-val ((m <Lane>))
...
(cl:ensure-generic-function 'expired_timestamp-val :lambda-list '(m))
(cl:defmethod expired_timestamp-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader routing_pb_msgs-msg:expired_timestamp-val is deprecated.  Use routing_pb_msgs-msg:expired_timestamp instead.")
  (expired_timestamp m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Lane>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'end_s))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'expired_timestamp))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Lane>)))
  ...
  (cl:format cl:nil "string id ~%float64 start_s ~%float64 end_s ~%float64 expired_timestamp ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Lane)))
  "Returns full string definition for message of type 'Lane"
  (cl:format cl:nil "string id ~%float64 start_s ~%float64 end_s ~%float64 expired_timestamp ~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Lane>))
  ...
  (cl:list 'Lane
    ...
    (cl:cons ':expired_timestamp (expired_timestamp msg))
))
