...
(cl:defmethod cl:initialize-instance :after ((m <Stats1D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stats1D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_exposure_msgs-msg:<Stats1D> is deprecated: use image_exposure_msgs-msg:Stats1D instead.")))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <Stats1D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_exposure_msgs-msg:min-val is deprecated.  Use image_exposure_msgs-msg:min instead.")
  (min m))

(cl:ensure-generic-function 'max-val :lambda-list '(m))
(cl:defmethod max-val ((m <Stats1D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_exposure_msgs-msg:max-val is deprecated.  Use image_exposure_msgs-msg:max instead.")
  (max m))

(cl:ensure-generic-function 'mean-val :lambda-list '(m))
(cl:defmethod mean-val ((m <Stats1D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_exposure_msgs-msg:mean-val is deprecated.  Use image_exposure_msgs-msg:mean instead.")
  (mean m))

(cl:ensure-generic-function 'variance-val :lambda-list '(m))
(cl:defmethod variance-val ((m <Stats1D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_exposure_msgs-msg:variance-val is deprecated.  Use image_exposure_msgs-msg:variance instead.")
  (variance m))

(cl:ensure-generic-function 'N-val :lambda-list '(m))
(cl:defmethod N-val ((m <Stats1D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_exposure_msgs-msg:N-val is deprecated.  Use image_exposure_msgs-msg:N instead.")
  (N m))
