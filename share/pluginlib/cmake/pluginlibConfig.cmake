...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/fengkaiwen/ros/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
