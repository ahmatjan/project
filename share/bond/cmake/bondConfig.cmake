...
if("FALSE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /home/fengkaiwen/ros/bond_core/bond)
  set(bond_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/bond)
  set(bond_INSTALL_PREFIX "")
  set(bond_PREFIX ${bond_DEVEL_PREFIX})
else()
  set(bond_SOURCE_PREFIX "")
  set(bond_DEVEL_PREFIX "")
  set(bond_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
