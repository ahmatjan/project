...
if("FALSE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/ros/drivers/src/car_ros_drivers/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/devel_isolated/velodyne_driver)
  ...
  set(velodyne_driver_INSTALL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'car-os <car-os@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/${idir}'.  Ask the maintainer 'car-os <car-os@todo.todo>' to fix it.")
    endif()
...
set(depends "diagnostic_updater;nodelet;roscpp;tf;velodyne_msgs;time_util")
