...
if("FALSE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /home/fengkaiwen/ros/ros_comm/rosnode)
  set(rosnode_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/rosnode)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
