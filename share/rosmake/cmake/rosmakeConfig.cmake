...
if("FALSE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /home/fengkaiwen/ros/ros/rosmake)
  set(rosmake_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/rosmake)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
