...
if("FALSE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/ros/pointcloud_to_laserscan)
  set(pointcloud_to_laserscan_DEVEL_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/devel_isolated/pointcloud_to_laserscan)
  ...
  set(pointcloud_to_laserscan_INSTALL_PREFIX /home/caros/ros)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caros/ros/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>' to fix it.")
    endif()
