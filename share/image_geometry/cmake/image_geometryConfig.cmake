...
if("FALSE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/fengkaiwen/ros/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include;/usr/include/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
