...
if("FALSE" STREQUAL "TRUE")
  ...
  set(image_geometry_INSTALL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated)
...
if(NOT "include;/usr/include/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
