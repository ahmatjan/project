...
if("FALSE" STREQUAL "TRUE")
  set(pcl_conversions_SOURCE_PREFIX /home/fengkaiwen/ros/pcl_conversions)
  set(pcl_conversions_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/pcl_conversions)
  ...
  set(pcl_conversions_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Bill Morris <bill@neautomation.com>' to fix it.")
    endif()
