...
if("FALSE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/fengkaiwen/ros/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/fengkaiwen/devel_isolated/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/fengkaiwen/caros/ros)
...
if(NOT "include;/usr/include/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengkaiwen/caros/ros/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
