...
if("FALSE" STREQUAL "TRUE")
  ...
  set(cv_bridge_INSTALL_PREFIX /home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated)
...
if(NOT "include;/usr/include/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
