...
if("FALSE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/ros/geometry2/tf2_ros)
  set(tf2_ros_DEVEL_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/devel_isolated/tf2_ros)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /home/caros/ros)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caros/ros/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
