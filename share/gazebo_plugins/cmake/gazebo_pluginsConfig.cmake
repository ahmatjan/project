...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_plugins_SOURCE_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/ros/gazebo_ros_pkgs/gazebo_plugins)
  set(gazebo_plugins_DEVEL_PREFIX /home/scmbuild/workspaces_cluster.tmp/tmp.20161206.225249.22574/baidu/adu/devel_isolated/gazebo_plugins)
  ...
  set(gazebo_plugins_INSTALL_PREFIX /home/caros/ros)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caros/ros/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>' to fix it.")
    endif()
