 ...
 *
 **/
#ifndef CAR_ROS_DRIVERS_VELODYNE_VELODYNE_POINTCLOUD_FUSION_H
#define CAR_ROS_DRIVERS_VELODYNE_VELODYNE_POINTCLOUD_FUSION_H
...
typedef message_filters::sync_policies::ApproximateTime<pc2, pc2, pc2, pc2, pc2> FiveMsgsSyncPolicy;

class Fusion {
public:
    Fusion(ros::NodeHandle nh, ros::NodeHandle private_nh);
    virtual ~Fusion();
    ...
    void pointcloud_fusion(const pc2ConstPtr &msg1, const pc2ConstPtr &msg2,
            const pc2ConstPtr &msg3, const pc2ConstPtr &msg4, const pc2ConstPtr &msg5);
...
private:
    ...
    message_filters::Synchronizer<FiveMsgsSyncPolicy>* _five_msgs_sync;
