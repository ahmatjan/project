...
#ifndef __hough_circles__HOUGHCIRCLESCONFIG_H__
#define __hough_circles__HOUGHCIRCLESCONFIG_H__
  ...
  public:
    ...
    public:
      ParamDescription(std::string name, std::string type, uint32_t level, 
          std::string description, std::string edit_method, T HoughCirclesConfig::* f) :
