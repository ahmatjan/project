...
#ifndef __contour_moments__CONTOURMOMENTSCONFIG_H__
#define __contour_moments__CONTOURMOMENTSCONFIG_H__
  ...
  public:
    ...
    public:
      ParamDescription(std::string name, std::string type, uint32_t level, 
          std::string description, std::string edit_method, T ContourMomentsConfig::* f) :
