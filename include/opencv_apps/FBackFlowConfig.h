...
// *********************************************************
// 
// File autogenerated for the fback_flow package 
// by the dynamic_reconfigure package.
// Please do not edit.
// 
// ********************************************************/

#ifndef __fback_flow__FBACKFLOWCONFIG_H__
#define __fback_flow__FBACKFLOWCONFIG_H__
  ...
  public:
    ...
    public:
      ParamDescription(std::string name, std::string type, uint32_t level, 
          std::string description, std::string edit_method, T FBackFlowConfig::* f) :
