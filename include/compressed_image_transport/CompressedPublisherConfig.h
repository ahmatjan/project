...
//#line 280 "/home/caros/ros/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CompressedPublisherConfig::AbstractParamDescriptionConstPtr(new CompressedPublisherConfig::ParamDescription<std::string>("format", "str", 0, "Compression format", "{'enum_description': 'Enum to set the compression format', 'enum': [{'srcline': 9, 'description': 'JPEG lossy compression', 'srcfile': '/home/scmbuild/workspaces_cluster/baidu.adu.ros/baidu/adu/ros/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'cconsttype': 'const char * const', 'value': 'jpeg', 'ctype': 'std::string', 'type': 'str', 'name': 'jpeg'}, {'srcline': 10, 'description': 'PNG lossless compression', 'srcfile': '/home/scmbuild/workspaces_cluster/baidu.adu.ros/baidu/adu/ros/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'cconsttype': 'const char * const', 'value': 'png', 'ctype': 'std::string', 'type': 'str', 'name': 'png'}]}", &CompressedPublisherConfig::format)));
//#line 280 "/home/caros/ros/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CompressedPublisherConfig::AbstractParamDescriptionConstPtr(new CompressedPublisherConfig::ParamDescription<std::string>("format", "str", 0, "Compression format", "{'enum_description': 'Enum to set the compression format', 'enum': [{'srcline': 9, 'description': 'JPEG lossy compression', 'srcfile': '/home/scmbuild/workspaces_cluster/baidu.adu.ros/baidu/adu/ros/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'cconsttype': 'const char * const', 'value': 'jpeg', 'ctype': 'std::string', 'type': 'str', 'name': 'jpeg'}, {'srcline': 10, 'description': 'PNG lossless compression', 'srcfile': '/home/scmbuild/workspaces_cluster/baidu.adu.ros/baidu/adu/ros/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg', 'cconsttype': 'const char * const', 'value': 'png', 'ctype': 'std::string', 'type': 'str', 'name': 'png'}]}", &CompressedPublisherConfig::format)));
//#line 280 "/home/caros/ros/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/scmbuild/workspaces_cluster/baidu.adu.ros/baidu/adu/ros/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg"
      const char * const CompressedPublisher_jpeg = "jpeg";
//#line 10 "/home/scmbuild/workspaces_cluster/baidu.adu.ros/baidu/adu/ros/image_transport_plugins/compressed_image_transport/cfg/CompressedPublisher.cfg"
