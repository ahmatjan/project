...
struct MD5Sum< ::novatel_msgs::INSPVAX_<ContainerAllocator> >
{
  ...
  {
    return "debd563bca8450a5102017dabebfa754";
  }

  static const char* value(const ::novatel_msgs::INSPVAX_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdebd563bca8450a5ULL;
  static const uint64_t static_value2 = 0x102017dabebfa754ULL;
};
