#ifndef MESSAGE_TRANSPORT_TRANSPORT_HINTS_H
#define MESSAGE_TRANSPORT_TRANSPORT_HINTS_H
...
public:
     ...
     * name of the desired transport. By default this parameter is named "message_transport"
