...
#include <image_exposure_msgs/Stats1D.h>
#include <image_exposure_msgs/Stats1D.h>
...
struct ImageExposureStatistics_
{
  ...
  _overExposed_type overExposed;
   ...
   typedef  ::image_exposure_msgs::Stats1D_<ContainerAllocator>  _pixelVal_type;
  _pixelVal_type pixelVal;

   typedef  ::image_exposure_msgs::Stats1D_<ContainerAllocator>  _pixelAge_type;
...
// {'image_exposure_msgs': ['/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/ros/drivers/src/car_ros_drivers/pointgrey_camera_3rd/image_exposure_msgs/msg'], 'std_msgs': ['/home/scmbuild/workspaces_cluster/baidu.car-os.ros/baidu/car-os/install_isolated/share/std_msgs/cmake/../msg']}
...
struct Printer< ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator>& v)
  {
    ...
    s << indent << "pixelVal: ";
    s << std::endl;
    Printer< ::image_exposure_msgs::Stats1D_<ContainerAllocator> >::stream(s, indent + "  ", v.pixelVal);
    s << indent << "pixelAge: ";
    s << std::endl;
    Printer< ::image_exposure_msgs::Stats1D_<ContainerAllocator> >::stream(s, indent + "  ", v.pixelAge);
