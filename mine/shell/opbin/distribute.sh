...
#order_list[0]='ssh ${user}@${host} "cat /home/${user}/id_rsa.pub >> /home/${user}/.ssh/authorized_keys"'
#order_list[2]='ssh ${user}@${host} "cat /home/${user}/id_rsa.pub > /home/${user}/.ssh/authorized_keys"'
#order_list[3]='ssh ${user}@${host} "rm /home/${user}/id_rsa.pub"'
#order_list[0]='ssh ${user}@${host} "cat /home/${user}/.ssh/authorized_keys"'
