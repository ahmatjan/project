...
"""autogenerated by genpy from hdmap_pb_msgs/YieldSign.msg. Do not edit."""
import sys
...
class YieldSign(genpy.Message):
  _md5sum = "a0b0a58beae153cdee258e81d56271a7"
  _type = "hdmap_pb_msgs/YieldSign"
...
"""
  __slots__ = ['id','stop_line','location','overlap_id']
  _slot_types = ['hdmap_pb_msgs/Id','hdmap_pb_msgs/Curve','hdmap_pb_msgs/Point','hdmap_pb_msgs/Id[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,stop_line,location,overlap_id
    ...
    """
    if args or kwds:
      super(YieldSign, self).__init__(*args, **kwds)
