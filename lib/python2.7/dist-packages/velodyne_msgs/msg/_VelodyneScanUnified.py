...
"""autogenerated by genpy from velodyne_msgs/VelodyneScanUnified.msg. Do not edit."""
import sys
...
class VelodyneScanUnified(genpy.Message):
  _md5sum = "a02f26cda99b9e0189aac08ed1065a71"
  _type = "velodyne_msgs/VelodyneScanUnified"
...
uint8[1206] data    #packet contents"""
  ...
  _slot_types = ['std_msgs/Header','uint64','velodyne_msgs/VelodynePacket[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VelodyneScanUnified, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_Q.pack(self.basetime))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.basetime,) = _struct_Q.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.packets = []
