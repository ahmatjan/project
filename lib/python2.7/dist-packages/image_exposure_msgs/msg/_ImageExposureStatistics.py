...
int64 N"""
  ...
  _slot_types = ['time','string','float32','float32','uint32','uint32','image_exposure_msgs/Stats1D','image_exposure_msgs/Stats1D','float64','float64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pixelVal is None:
        self.pixelVal = image_exposure_msgs.msg.Stats1D()
      if self.pixelAge is None:
        self.pixelAge = image_exposure_msgs.msg.Stats1D()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2f2I4dq4dq5d.pack(_x.shutterms, _x.gaindb, _x.underExposed, _x.overExposed, _x.pixelVal.min, _x.pixelVal.max, _x.pixelVal.mean, _x.pixelVal.variance, _x.pixelVal.N, _x.pixelAge.min, _x.pixelAge.max, _x.pixelAge.mean, _x.pixelAge.variance, _x.pixelAge.N, _x.meanIrradiance, _x.minMeasurableIrradiance, _x.maxMeasurableIrradiance, _x.minObservedIrradiance, _x.maxObservedIrradiance))
