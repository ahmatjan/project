...
"""autogenerated by genpy from decision_pb_msgs/ObjectDecisions.msg. Do not edit."""
import sys
...
class ObjectDecisions(genpy.Message):
  _md5sum = "f350af6d937109eae881094b92443486"
  _type = "decision_pb_msgs/ObjectDecisions"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """ObjectDecision[] decision 
...
"""
  __slots__ = ['decision']
  _slot_types = ['decision_pb_msgs/ObjectDecision[]']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.decision)
      buff.write(_struct_I.pack(length))
      for val1 in self.decision:
        _v1 = val1.prediction
