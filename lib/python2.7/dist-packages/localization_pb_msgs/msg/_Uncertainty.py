...
"""autogenerated by genpy from localization_pb_msgs/Uncertainty.msg. Do not edit."""
import sys
...
class Uncertainty(genpy.Message):
  ...
  _type = "localization_pb_msgs/Uncertainty"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """common_pb_msgs/Point3D position_std_dev 
...
"""
  ...
  _slot_types = ['common_pb_msgs/Point3D','common_pb_msgs/Point3D','common_pb_msgs/Point3D','common_pb_msgs/Point3D','common_pb_msgs/Point3D']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.position_std_dev is None:
        self.position_std_dev = common_pb_msgs.msg.Point3D()
      if self.orientation_std_dev is None:
        self.orientation_std_dev = common_pb_msgs.msg.Point3D()
      if self.linear_velocity_std_dev is None:
        self.linear_velocity_std_dev = common_pb_msgs.msg.Point3D()
      if self.linear_acceleration_std_dev is None:
        self.linear_acceleration_std_dev = common_pb_msgs.msg.Point3D()
      if self.angular_velocity_std_dev is None:
        self.angular_velocity_std_dev = common_pb_msgs.msg.Point3D()
    else:
      self.position_std_dev = common_pb_msgs.msg.Point3D()
      self.orientation_std_dev = common_pb_msgs.msg.Point3D()
      self.linear_velocity_std_dev = common_pb_msgs.msg.Point3D()
